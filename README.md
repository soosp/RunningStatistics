...
|`alpha()`|Returns the stored smoothing factor alpha.|
|`computeAlpha(float dtSeconds, float tauSeconds)`|Compute the EMA smoothing factor alpha for a given sample interval and time constant.|
